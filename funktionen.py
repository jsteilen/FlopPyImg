...
def volumeMetadata(basicPath, name, media, label, description, remarks):
	...
	statusImg, fileImg = checkWittenFile('.img', basicPath)
	statusMd5, fileMd5 = checkWittenFile('.md5', basicPath)
	statusLst, fileLst = checkWittenFile('.lst', basicPath)
